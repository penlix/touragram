...
test('classifyPhoto reports blocklist for chrome filenames', () => {
  assert.equal(classifyPhoto({ mime: 'image/png', width: 800, url: 'Commons-logo.png', thumburl: 't.png' }), 'blocklist');
});
